// @ts-nocheck
/**
 * TitanCrew Â· Scheduling Agent â Propose Slots
 *
...
export async function POST(req: NextRequest) {
  ...
  // ââ Fetch techs for this account ââââââââââââââââââââââââââââ
  ...
  // ââ Determine search window âââââââââââââââââââââââââââââââââ
  ...
  // ââ Fetch existing jobs in the window âââââââââââââââââââââââ
  ...
  // ââ Build availability map per tech âââââââââââââââââââââââââ
  ...
  for (const tech of techs) {
    ...
    while (currentDay < searchEnd && proposals.length < 9) {
      ...
      for (const candidateStart of slotCandidates) {
        ...
        // ââ Score this slot âââââââââââââââââââââââââââââââââ
        let score = 100;
  ...
  // ââ Sort by score and return top 3 ââââââââââââââââââââââââââ
