                ...
                <tr key={acc.id} className="hover:bg-white/[0.03] transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        onClick={() => handleFlag(acc.id, !acc.flagged_for_review)}
                        className={`p-1.5 rounded hover:bg-white/10 transition-colors ${acc.flagged_for_review ? "text-amber-400" : "text-slate-400 hover:text-amber-400"}`}
                        title={acc.flagged_for_review ? "Unflag" : "Flag for review"}
                      >
                      ...
                      {acc.suspended_at ? (
                        <button
                          ...
                          className="p-1.5 rounded hover:bg-white/10 text-red-400 hover:text-emerald-400 transition-colors"
                          title="Unsuspend"
                        >
