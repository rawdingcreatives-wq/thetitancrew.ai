...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const [
        accountsRes, activeRes, trialRes, canceledRes, mrrRes,
        agentsRunningRes, agentsErrorRes, recentRes, ticketsRes,
        churnRiskRes, agentErrorListRes,
      ] = await Promise.all([
      ...
      const totalMRR = (mrrRes.data ?? []).reduce((sum, a) => sum + (parseFloat(a.mrr) || 0), 0);
