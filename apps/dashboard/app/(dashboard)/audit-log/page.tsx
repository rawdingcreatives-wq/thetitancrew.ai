          ...
          {/* Header */}
              <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                                ...
                                <div>
                                            <h1 className="text-2xl font-bold text-[#1A2744]">Audit Log</h1>h1>
                      ...
                      <div className="flex items-center gap-3">
                                <div className="flex items-center gap-1.5 text-xs text-gray-500 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
                                            <Lock size={12} />
                                            <span>Append-only · No deletions possible</span>span>
                                </div>div>
                                <a
          ...
          {/* Legal Notice */}
              <div className="text-center text-xs text-gray-400">
                      <p>
                                ...
                                <a href="/compliance" className="text-[#FF6B00] hover:underline">Data Processing Agreement</a>a>.
